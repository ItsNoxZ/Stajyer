...
SpringDoc OpenAPI (Swagger): API dokümantasyonunun otomatik üretilmesi, canlı test edilmesi ve arayüze eklenen özel butonlar/özelliklerle (örneğin kayıt ve GitHub yönlendirmeleriyle) zenginleştirilmesi için.
