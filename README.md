...
flowchart TD
    ...
    %% Steps
    Start["1. İstemci İstegi"]:::stepStyle
    ControllerNode["2. Controller Katmanı"]:::processStyle
    Branch{"3. Yönlendirme"}:::processStyle
    ListenerNode["4. Bellek (In-Memory)"]:::storageStyle
    ProducerNode["5. Kafka Sender"]:::kafkaStyle
    KafkaNode["6. Apache Kafka"]:::kafkaStyle

    Start --> ControllerNode
    ControllerNode --> Branch
    Branch -->|"Veri"| ListenerNode
    Branch -->|"Event"| ProducerNode
    ProducerNode --> KafkaNode
